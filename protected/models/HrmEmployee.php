...
class HrmEmployee extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('emp_primary_address, emp_primary_city, emp_primary_state, emp_primary_country, emp_primary_pincode, emp_permanent_address, emp_permanent_city, emp_permanent_state, emp_permanent_country, emp_permanent_pincode, emp_dob, emp_home_phone, emp_mobile, emp_additional_notes', 'required'),
			...
			array('emp_lastname, emp_firstname, emp_middle_name, emp_nick_name, emp_dri_lice_num', 'length', 'max'=>100),
